...
const redact = document.getElementById("redact-1");
const glory = document.getElementById("glory-1");
...
const abaab = document.getElementById("abaab-1");
const sans = document.getElementById("index-1");
...
function content2008Function() {
  if (ohEight.style.display === "none") {
    ohEight.style.display = "block";
    cws.style.display = "none";
    cmyk.style.display = "none";
    redact.style.display = "none";
    tsar.style.display = "none";
...
function contentcwsFunction() {
  if (cws.style.display === "none") {
    cws.style.display = "block";
    ohEight.style.display = "none";
    cmyk.style.display = "none";
    redact.style.display = "none";
    tsar.style.display = "none";
...
function contentcmykFunction() {
  if (cws.style.display === "none") {
    cmyk.style.display = "block";
    cws.style.display = "none";
    ohEight.style.display = "none";
    redact.style.display = "none";
    tsar.style.display = "none";
...
function contentredactFunction() {
  if (redact.style.display === "none") {
...
function contentgloryFunction() {
  if (glory.style.display === "none") {
...
function contentstrelkaFunction() {
  if (strelka.style.display === "none") {
...
function contentddgFunction() {
  if (ddg.style.display === "none") {
...
function contentabaabFunction() {
  if (abaab.style.display === "none") {
    abaab.style.display = "block";
    ddg.style.display = "none";
    strelka.style.display = "none";
    script.style.display = "none";
    sos.style.display = "none";
...
function contentindexFunction() {
  if (sans.style.display === "none") {
...
function contenttrishaFunction() {
  if (trisha.style.display === "none") {
